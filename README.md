...
- **Scheduling.** The first complete match in left-hand-side order over the oldest surviving occurrences. This is a project convention. It is not a claim of parity with the SetReplace default event ordering.
...
Expected one-event results were derived by hand from the cited descriptions and encoded as tests. No WolframModel or SetReplace software was executed as an oracle.
...
- Not verified: agreement with SetReplace or WolframModel on any evolution beyond the encoded fixtures, multiway behavior, and any physical interpretation.
